...
void render_draw_call2(render_target_t render_target, render_command_t command) {
  ...
  for (uint32_t vertex_index = 0; vertex_index + 2 < command.mesh->count; vertex_index += 3){
    ...
    for (vertex* triangle_begin = clipped_vertices; triangle_begin != clipped_vertices_end; triangle_begin += 3){
      ...
      vec4f_t edge_v0_tilev0 = {};
      vec4f_t edge_v1_tilev0 = {};
      vec4f_t edge_v2_tilev0 = {};
      vec4f_t edge_v0_tilev1 = {};
      vec4f_t edge_v1_tilev1 = {};
      vec4f_t edge_v2_tilev1 = {};
      vec4f_t edge_v0_tilev2 = {};
      vec4f_t edge_v1_tilev2 = {};
      vec4f_t edge_v2_tilev2 = {};
      vec4f_t edge_v0_tilev3 = {};
      vec4f_t edge_v1_tilev3 = {};
      vec4f_t edge_v2_tilev3 = {};
      ...
      for (int32_t tile_y = ymin; tile_y < ymax; tile_y += tile_height){
        for (int32_t tile_x = xmin; tile_x < xmax; tile_x += tile_width){
          //set up the 4 vectors for the 4 point in triangle tests
          vec4f_t tile_v0 = (vec4f_t){tile_x + 0.5f, tile_y + 0.5f, 0.f, 0.f};
          vec4f_t tile_v1 = (vec4f_t){tile_x + tile_width + 0.5f, tile_y + 0.5f, 0.f, 0.f};
          vec4f_t tile_v2 = (vec4f_t){tile_x + tile_width + 0.5f, tile_y + tile_height + 0.5f, 0.f, 0.f};
          vec4f_t tile_v3 = (vec4f_t){tile_x + 0.5f, tile_y + tile_height + 0.5f, 0.f, 0.f};
          
          //v0
          psub_vec4f(&edge_v0_tilev0, &tile_v0, &v0);
          psub_vec4f(&edge_v1_tilev0, &tile_v0, &v1);
          psub_vec4f(&edge_v2_tilev0, &tile_v0, &v3);
          float det_v0_v1_tilev0 = det2d_vec4f(edge_v0_v1, edge_v0_tilev0);
          float det_v1_v2_tilev0 = det2d_vec4f(edge_v1_v2, edge_v1_tilev0);
          float det_v2_v0_tilev0 = det2d_vec4f(edge_v2_v0, edge_v2_tilev0);
          bool tile_v0_check = (det_v0_v1_tilev0 >= 0.f && det_v1_v2_tilev0 >= 0.f && det_v2_v0_tilev0 >= 0.f);

          //v1
          psub_vec4f(&edge_v0_tilev1, &tile_v1, &v0);
          psub_vec4f(&edge_v1_tilev1, &tile_v1, &v1);
          psub_vec4f(&edge_v2_tilev1, &tile_v1, &v3);
          float det_v0_v1_tilev1 = det2d_vec4f(edge_v0_v1, edge_v0_tilev1);
          float det_v1_v2_tilev1 = det2d_vec4f(edge_v1_v2, edge_v1_tilev1);
          float det_v2_v0_tilev1 = det2d_vec4f(edge_v2_v0, edge_v2_tilev1);
          bool tile_v1_check = (det_v0_v1_tilev1 >= 0.f && det_v1_v2_tilev1 >= 0.f && det_v2_v0_tilev1 >= 0.f);

          //v2
          psub_vec4f(&edge_v0_tilev2, &tile_v2, &v0);
          psub_vec4f(&edge_v1_tilev2, &tile_v2, &v1);
          psub_vec4f(&edge_v2_tilev2, &tile_v2, &v3);
          float det_v0_v1_tilev2 = det2d_vec4f(edge_v0_v1, edge_v0_tilev2);
          float det_v1_v2_tilev2 = det2d_vec4f(edge_v1_v2, edge_v1_tilev2);
          float det_v2_v0_tilev2 = det2d_vec4f(edge_v2_v0, edge_v2_tilev2);
          bool tile_v2_check = (det_v0_v1_tilev2 >= 0.f && det_v1_v2_tilev2 >= 0.f && det_v2_v0_tilev2 >= 0.f);

          //v3
          psub_vec4f(&edge_v0_tilev3, &tile_v3, &v0);
          psub_vec4f(&edge_v1_tilev3, &tile_v3, &v1);
          psub_vec4f(&edge_v2_tilev3, &tile_v3, &v3);
          float det_v0_v1_tilev3 = det2d_vec4f(edge_v0_v1, edge_v0_tilev3);
          float det_v1_v2_tilev3 = det2d_vec4f(edge_v1_v2, edge_v1_tilev3);
          float det_v2_v0_tilev3 = det2d_vec4f(edge_v2_v0, edge_v2_tilev3);
          bool tile_v3_check = (det_v0_v1_tilev3 >= 0.f && det_v1_v2_tilev3 >= 0.f && det_v2_v0_tilev3 >= 0.f);
